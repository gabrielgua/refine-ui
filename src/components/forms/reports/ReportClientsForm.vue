...
const clientFields: FormField[] = [
  { key: 'dateType', type: 'dropdown', label: 'Tipo da Data', placeholder: 'Selecione...', selectOptions: [{ value: 'Todos', label: 'Todos' }] },
  { key: 'dateFrom', type: 'datetime-local', label: 'De', placeholder: 'Data de início' },
  { key: 'dateTo', type: 'datetime-local', label: 'Até', placeholder: 'Data de fim' },
  ...
  {
    key: 'balanceStatus', type: 'dropdown', label: 'Status do Saldo', placeholder: 'Selecione Status...', selectOptions: [
