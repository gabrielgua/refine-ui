...
import { ICON_END_STYLES, ICON_START_STYLES, type BaseInputProps, type InputSize } from '@/types/input';
...
<template>
  <div class="grid gap-2">
    ...
    <div
      ...
      :class="{ '!ring-0 !ring-transparent !ring-transparent !bg-opacity-30 outline-dashed outline-1 outline-zinc-200 dark:outline-zinc-700': disabled }">
