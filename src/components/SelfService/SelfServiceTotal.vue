...
<template>
  <Card>
    <CardTitle icon="fa-receipt" :class="{ 'py-2 pe-2': cartStore.valid }">
      <div class="flex items-center justify-between w-full">
        <p>Precificação</p>
        <Button v-if="cartStore.valid" variant="secondary" :click="() => togglePriceInfoModal()">
